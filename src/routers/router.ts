import { Route as QuickV2RouteRaw } from '@davidwgrossman/quickswap-sdk';
import { Route as PancakeV2RouteRaw } from '@pancakeswap/sdk';
import { Route as SushiV2RouteRaw, Token as SToken } from '@sushiswap/sdk';
import { CondensedAddLiquidityOptions } from '@uniswap/router-sdk';
import {
  Currency,
  Fraction,
  Percent,
...
export class QuickV2Route extends QuickV2RouteRaw {}
export class SushiV2Route extends SushiV2RouteRaw<SToken, SToken> {}
export class PancakeV2Route extends PancakeV2RouteRaw {}
