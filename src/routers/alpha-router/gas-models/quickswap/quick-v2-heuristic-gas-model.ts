 ...
 */
export class QuickV2HeuristicGasModelFactory extends IV2GasModelFactory {
  constructor() {
    super();
  }
  ...
  private async getHighestLiquidityUSDPool(
    ...
    let quickUsdTokens: TokenRaw[] = usdTokens;
    const usdPools = _.map<TokenRaw, [TokenRaw, TokenRaw]>(
      quickUsdTokens,
